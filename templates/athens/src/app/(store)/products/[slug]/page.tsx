  ...
  return (
    <div className="container min-h-screen py-8">
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
        <div id="__product-gallery" className="grid grid-cols-5 gap-3 sm:gap-4">
          <div className="hidden space-y-4 sm:block max-h-[680px] overflow-y-auto">
          ...
          <div className="col-span-full h-[440px] overflow-clip rounded-md border border-stone-200 sm:col-span-4 sm:h-[680px]">
            <Image
              src={
