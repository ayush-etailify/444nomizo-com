export default function PrivacyPolicyPage() {
  return (
    <div>
      <h2 className="font-medium text-xl uppercase">Privacy Policy</h2>
      <article className="space-y-4 mt-6">
        ...
        <ul>
          ...
          <li>
            ...
            accessible from www.444Nomizo444nomizo.com
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            <em>Where</em>can<em>I</em>change<em>the</em>settings<em>for</em>
            disabling__or<em>deleting</em>local<em>shared</em>objects_
          </li>
          <li>
        ...
        <p>By email: support444nomizo.com</p>
      </article>
    </div>
  );
}
