export default function TermsAndConditionsPage() {
  return (
    <div className="flex flex-col gap-4 max-w-5xl mx-auto">
      <h2 className="text-2xl font-bold uppercase italic mb-6">
        Terms and Conditions
      </h2>
      <p>
        This website is operated by 444Nomizo. Throughout the site, the terms
        “we”, “us” and “our” refer to 444Nomizo. 444Nomizo offers this website,
      ...
      <p>
        ...
        return or exchange only according to our Refund Policy: [LINK TO REFUND
        ...
        will be accurate. We reserve the right, but are not obligated, to limit
      ...
      <p>
        ...
        can be viewed here: [LINK TO PRIVACY POLICY]
      </p>
      <p>
      ...
      <p>
        ...
        non-infringement. In no case shall 444Nomizo, our directors, officers,
      ...
      <p>
        ...
        harmless 444Nomizo and our parent, subsidiaries, affiliates, partners,
